...
In The Netherlands, the vaccination passport is hot topic in discussions and of high interest to governmental institutions as well as the food and beverages and entertainment business. Should this be implemented? And if so, how? This study will analyze data on tweets about the vaccination passport.

## Research Question

How do people in The Netherlands tweet about (the implementation of) the vaccination passport?

**Sub-Questions:** (if any)

Are Dutch citizens overall in favor or against the vaccination passport, according to tweets?
